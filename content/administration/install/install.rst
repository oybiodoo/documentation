...
For Debian based systems, those packages are listed in the
`debian/control <https://github.com/odoo/odoo/blob/master/debian/control>`_ file of the odoo sources.
