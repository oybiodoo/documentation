...
An FEC audit file (Fichier des Écritures Comptables) contains all the accounting data and entries
...
**Example**: the account code 65800000 in the file is matched against an existing 658000 account in
...
- Produits divers de gestion courante (758000) for added credits
